// Fixed version of clsDate.h
// Adjusted for portability (removed MSVC-only __declspec(property))
// Fixed logic bugs (days in year, recursion/return mistakes) and added missing includes
...
public:
	...
	// Getters / Setters (keep for API compatibility)
	...
	{
		// CORRECTION: leap year has 366 days, otherwise 365
	...
	{
		// invert the IsWeekEnd: this will save updating code.
